...
## Project Structure
    ...
    ├── top_grade_educunsul_30193  # Django project configurations
...
1. Clone this repo and `cd top_grade_educunsul_30193`
...
2. Clone this repo and `cd top_grade_educunsul_30193`
